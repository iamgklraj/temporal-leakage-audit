...
|---|---|---|
| **Instrument validation** (synthetic data, known leakage) | 100 replicates at each of six leakage levels: with no leakage the CI lies above 0 in 2% of replicates (nominal 2.5%); LAP rises monotonically with true leakage; detection 55% at LAP ≈ 0.06, 96% at ≈ 0.11; CI coverage 87–95%. | `outputs/instrument_validation.json` |
